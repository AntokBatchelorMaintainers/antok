...
class bin0r {
  ...
  public:
	...
	void writeFitResultsToAscii(std::string fileNamePrefix) {
		...
		std::ofstream file_lu;
		std::ofstream file_ml;
		std::ofstream file_mu;
		std::ofstream file_rl;
		std::ofstream file_ru;
		std::ofstream file_lp;
		std::ofstream file_lw;
		std::ofstream file_mp;
		std::ofstream file_mw;
		std::ofstream file_rp;
		std::ofstream file_rw;
